<template>
    <nav class="navtab">
  <ul>
    <li class="navtab-item" @click="setActive(0)" v-bind:class="{active:0==current}">
    ...
    <li class="navtab-item" @click="setActive(1)" v-bind:class="{active:1==current}">
    ...
    <li class="navtab-item" @click="setActive(2)" v-bind:class="{active:2==current}">
    ...
    <li class="navtab-item" @click="setActive(3)" v-bind:class="{active:3==current}">
